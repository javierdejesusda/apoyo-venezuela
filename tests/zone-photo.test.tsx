...
describe('ZonePhoto', () => {
  ...
  it('serves the raw Storage object URL, never the billed transformation endpoint', () => {
    const raw = 'https://x.supabase.co/storage/v1/object/public/fotos/a.jpg';
    render(<ZonePhoto src={raw} alt="Foto de la zona Centro" />);
